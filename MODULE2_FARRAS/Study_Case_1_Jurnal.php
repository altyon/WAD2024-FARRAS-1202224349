...
if (empty($MK_KI1201) || empty($MK_KU1202) || empty($MK_KU1102)) {
    $error = "Score field cannot be empty!";
} else {
// **********************  2  ************************** 
        ...
        <div class="col-md-4">
            <div class="card">
                ...
                <h3>Masukkan nilai mata kuliah anda pada form dibawah ini</h3>
                    <form action="" method="POST">
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="MK_KI1201" name="MK_KI1201" aria-label="Default select example">
                                <option selected value="">Input Score</option>
                    ...
                    //  **********************  4  **************************     
                    if (!empty($hasil)) {
                        echo "<div class='alert alert-success'>You are able to apply in: $hasil</div>";
                    }
                    //  **********************  4  **************************     
