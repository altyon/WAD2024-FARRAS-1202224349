<nav>
    <div class="d-flex flex-column align-items-center align-items-sm-start px-3 pt-3 text-white min-vh-100">
        <a href="/" class="d-flex align-items-center pb-3 mb-md-3 me-md-auto text-white text-decoration-none">
            <span class="fs-5 d-none d-sm-inline fw-bold">Student/Lecturer Management System</span>
        </a>
        <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
            ...
            {{-- Koleksi Lecturer --}}
            <li class="mb-3 @if (Route::is('lecturer.index')) fw-bold ms-3 @endif">
                <a href="/lecturer" class="nav-link px-0 align-middle text-white d-flex">
                    <div class="">
                        <span class="material-symbols-rounded">
                            book_4
                        </span>
                    ...
                    <div class="ms-3 d-none d-sm-inline">
                        <span>Koleksi Lecturer</span>
                    </div>
                    @if (Route::is('lecturer.index'))
                        <div class="ms-3">
                            <span class="material-symbols-rounded fs-6 text-warning shadow">circle</span>
                        </div>
                    @endif
            ...
            {{-- Koleksi Student --}}
            <li class="mb-3 @if (Route::is('student.index')) fw-bold ms-3 @endif">
                <a href="/student" class="nav-link px-0 align-middle text-white d-flex">
                    <div class="">
                        <span class="material-symbols-rounded">
                            people
                        </span>
